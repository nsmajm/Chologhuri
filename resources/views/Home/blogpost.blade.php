            ...
            {{--<div class="row ">--}}
                {{--<div class="col-4  post-item" >--}}
                    ...
                    {{--<div class="post-action">--}}
                            {{--<span class="action-left">10 Days ago</span>--}}
                            {{--<span class="action-right"><a class="read-more-button" href="#">Read more</a></span>--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{----}}
                {{--<div class="col-4 post-item" >--}}
                    ...
                    <div class="post-wrapeer">
                        <div class="card">
                            <div class="post-thumb position-a">
                                <img class="card-img-top" src="http://nscreativestudio.com/kanamachi/kanamachi/img/post/fetures/post1.jpg" alt="post">
